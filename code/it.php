...
<hr><h3>INFORMATION TECHNOLOGIE</h3>
<p>The IT department is an academic or professional unit within an organization that is responsible for managing and maintaining the information technology infrastructure of the organization. This includes hardware, software, and networking systems, as well as data management and security.</p>
</center>
<?php
...
$sql = "SELECT * FROM adminprofile WHERE dep= 'IT'";
