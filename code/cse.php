...
<hr><h3>COMPUTER SCIENCE AND ENGINEERING</h3>
<p>The CSE department is an academic unit within a college or university that is responsible for teaching and conducting research in the field of computer science and engineering. The department typically consists of faculty members, staff, and students who are dedicated to advancing the field of computer science and engineering through education, research, and innovation</p>
</center>
<?php
...
$sql = "SELECT * FROM adminprofile WHERE dep= 'CSE'";
