...
<p>The Mechanical Engineering department is an academic unit within a college or university that is responsible for teaching and conducting research in the field of Mechanical Engineering. The department typically consists of faculty members, staff, and students who are dedicated to advancing the field of mechanical engineering through education, research, and innovation</p></center>
<?php
...
$sql = "SELECT * FROM adminprofile WHERE dep= 'mech'";
