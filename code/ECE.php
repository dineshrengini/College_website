...
<hr><h3>ELECTRONICS AND COMMUNICATION ENGINEERING</h3>
<p>The ECE department is an academic unit within a college or university that is responsible for teaching and conducting research in the field of Electrical and Computer Engineering. The department typically consists of faculty members, staff, and students who are dedicated to advancing the field of electrical and computer engineering through education, research, and innovation.</p>
</center>
<?php
...
$sql = "SELECT * FROM adminprofile WHERE dep= 'ECE'";
